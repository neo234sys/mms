...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		corsConfiguration.setAllowedOrigins(List.of("http://localhost:54664","http://localhost:8090","http://localhost:3000","http://localhost:3001",
				"https://dev.selfserviceteam.com","https://ppe.selfserviceteam.com"));
		...
		and().csrf().disable()
			...
			.sessionManagement().sessionCreationPolicy(SessionCreationPolicy.STATELESS).and()
			 ...
			 .authorizeRequests().antMatchers("/api/subs/**").permitAll()
